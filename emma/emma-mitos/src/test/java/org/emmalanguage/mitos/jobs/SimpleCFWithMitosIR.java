...
public class SimpleCFWithMitosIR {

    private static TypeSerializer<Integer> integerSer = TypeInformation.of(Integer.class)
        .createSerializer(new ExecutionConfig());
    private static TypeSerializer<Boolean> booleanSer = TypeInformation.of(Boolean.class)
        .createSerializer(new ExecutionConfig());
...
//        final int n = Integer.parseInt(args[0]);
        ...
        LabyNode<Integer, Boolean> smallerThan =
            new LabyNode<>("smaller-than", new SmallerThan(n), 1, new Always0<>(1), integerSer,
                TypeInformation.of(new TypeHint<ElementOrEvent<Boolean>>() {
                }))
        ...
        LabyNode<Integer, Unit> printNode =
            new LabyNode<>("print-phase", new Print<>("print count value"), 2, new Always0<>(1), integerSer,
                TypeInformation.of(new TypeHint<ElementOrEvent<Unit>>() {
                }))
